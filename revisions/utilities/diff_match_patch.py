...
class diff_match_patch:
  ...
  def diff_prettyHtml(self, diffs, ins_color="#69EC69", del_color="#EC6969"):
    ...
    for (op, data) in diffs:
      ...
      if op == self.DIFF_INSERT:
        html.append("<ins style=\"background:%s;\">%s</ins>" % (ins_color, text))
      elif op == self.DIFF_DELETE:
        html.append("<del style=\"background:%s;\">%s</del>" % (del_color, text))
